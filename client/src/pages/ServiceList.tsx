                ...
                <Card className="glass group cursor-pointer border-white/5 hover:border-primary/40 transition-all duration-500 rounded-[2rem] overflow-hidden">
                  <CardContent className="p-8 flex items-center justify-between">
                    <div className="space-y-2">
                      <h3
                        className={`text-2xl font-bold group-hover:text-primary transition-colors ${lang === "ur" ? "font-urdu text-3xl" : ""}`}
                      >
                        {t(service.titleEn, service.titleUr)}
                      </h3>
                      <p
                        className={`text-muted-foreground line-clamp-2 ${lang === "ur" ? "font-urdu text-lg" : ""}`}
                      >
